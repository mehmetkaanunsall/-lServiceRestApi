...
@ManagedBean
@ViewScoped
public class IncomeBean extends GeneralBean<IncomeExpense> {
    ...
    public void init() {
        ...
        expanded=true;
        listOfIncomeExpense = incomeExpenseService.selectIncomeExpense(true);
        createTree();
    ...
    public void create() {
        ...
        selectedObject.setIsIncome(true);
