...
public class CreateAnalyzeReIndexDatabaseJob implements Job{
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        System.out.println("------CreateAnalyzeReIndexDatabaseJob Başladı!!");
        this.databaseMaintenanceService.analyzeReindexDatabase();
